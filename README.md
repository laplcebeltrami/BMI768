...
The course evaluation is based on extended homework assignments (50%) and final project report (50%) related activities. For each homework assignment, assessment consists of (i) a written report with accompanying MATLAB codes and (ii) an oral presentation of the student’s solution. Problems will be drawn from instructor-curated problem sets, and each student will be assigned a distinct set of problems from their peers. For the final project, assessment consists of (i) a final project report with accompanying MATLAB codes and (ii) a final oral presentation. Project topics are open-ended, and students can choose any topic or dataset, but the project should be based on methods learned through the homework assignments. PhD students who are already engaged in research may use their own datasets, provided that the project applies methods learned through the homework assignments.
