function S = PH_connectivity2simplex_iterative(C, tau, maxDim)
% PH_connectivity2simplex_iterative constructs a simplicial complex from a 
...
%
%   S = PH_connectivity2simplex_iterative(C, tau, maxDim) builds a simplicial
